...
while True:
    ...
    time.sleep(pause)
    main_elements = driver.find_elements(By.XPATH, '//*[@id="app"]/div[1]/div[2]/div/div[2]/div[2]')
    
    exclude_elements = driver.find_elements(By.XPATH, '//*[@id="app"]/div[1]/div[2]/div/div[2]/div[2]/div[4]/div[6]/div[102]/div/div[2]')
